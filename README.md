...
| Risk Management | Payout History | `/risk-management/payout-history` | Look up a recipient's bank account → every Anypay merchant that has paid out to it (successful payouts only), aggregated per merchant with totals and Excel export |
